...
Param (
    ...
    [String] $LighthouseTemplateParameterFileUri = "https://raw.githubusercontent.com/EdWire/Infrastructure/master/Lighthouse/lighthouseTemplate.volusia-edwire.parameters.json",
    [Switch] $ValidateOnly 
)
